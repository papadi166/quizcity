<template>
  ...
  <header>
    ...
    <h1 class="leaderboard__title"><span class="leaderboard__title--top">Best in</span><span class="leaderboard__title--bottom">Leaderboard</span></h1>
  </header>
  
  <main class="leaderboard__profiles">
    <article class="leaderboard__profile" v-for="player in players" :key="player.id">
      ...
      <span class="leaderboard__value">{{player.trophies}}<span>B</span></span>
    </article>
...
export default {
    ...
    data() {
        return {
            quiz_name: window.location.pathname.split('/')[2].replace('-',' '),
        }
    },
